 ...
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |  ,<  |  .>  |  /?  |  \|  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |  Tab | GUI  |  Alt |Adjust|Lower |Space |Enter |Raise |  [{  |  ]}  |  -_  |  =+  |
 * `-----------------------------------------------------------------------------------'
 */
[_NORMAL] = KEYMAP( \
  ...
  KC_TAB,  KC_LALT, KC_LGUI, ADJUST,  LOWER,   KC_SPC,  KC_ENT,  RAISE,   KC_LBRC, KC_RBRC, KC_MINS, KC_EQL   \
),
