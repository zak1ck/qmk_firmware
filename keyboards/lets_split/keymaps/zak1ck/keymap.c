...
[_NORMAL] = KEYMAP( \
  ...
  KC_LCTRL,KC_LGUI, KC_LALT, ADJUST,  LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_SLSH, KC_LEFT, KC_DOWN, KC_RGHT \
),
...
[_LOWER] = KEYMAP( \
  ...
  _______, _______, _______, _______, _______, _______, _______, S(KC_NUHS), S(KC_NUBS), KC_QUES, _______, _______, \
